/*
  ...
  ENCENDER LEDS DE FORMA ALEATORIA
...
void loop() {
  //la variable i sera escogida de forma aleatoria, entre 0 y cuatro.
  i=random(0,4);
  digitalWrite(led[i], true); //encender
  delay(1000); //esperar 1 s
  digitalWrite(led[i], false); // apagar
}
